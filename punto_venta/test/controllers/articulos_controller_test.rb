...
class ArticulosControllerTest < ActionController::TestCase
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post :create, articulo: { descripcion: @articulo.descripcion, existencia: @articulo.existencia, nombre: @articulo.nombre, precio_compra: @articulo.precio_compra, precio_venta: @articulo.precio_venta }
    end
  ...
  test "should update articulo" do
    patch :update, id: @articulo, articulo: { descripcion: @articulo.descripcion, existencia: @articulo.existencia, nombre: @articulo.nombre, precio_compra: @articulo.precio_compra, precio_venta: @articulo.precio_venta }
    assert_redirected_to articulo_path(assigns(:articulo))
  end
